...
import com.br.pdvpostocombustivelbackend.api.custo.dto.CustoResponse;
import com.br.pdvpostocombustivelbackend.domain.entity.Custo;
import com.br.pdvpostocombustivelbackend.domain.repository.CustoRepository;
...
public class CustoService {
    ...
    private Custo toEntity(com.br.pdvpostocombustivelbackend.api.custo.dto.CustoRequest req) {
        return new Custo(
                req.imposto(),
                req.frete(),
                req.seguro(),
