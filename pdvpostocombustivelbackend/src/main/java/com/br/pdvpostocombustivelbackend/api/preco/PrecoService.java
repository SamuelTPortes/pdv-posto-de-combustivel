package com.br.pdvpostocombustivelbackend.api.preco;

import com.br.pdvpostocombustivelbackend.api.preco.dto.PrecoRequest;
import com.br.pdvpostocombustivelbackend.api.preco.dto.PrecoResponse;
import com.br.pdvpostocombustivelbackend.domain.entity.Preco;
import com.br.pdvpostocombustivelbackend.domain.repository.PrecoRepositoy;
...
public class PrecoService {
    ...
    private Preco toEntity(com.br.pdvpostocombustivelbackend.api.preco.dto.PrecoRequest req) {
        return new Preco(
                req.valor(),
                req.dataAlteracao(),
                req.horaAlteracao(),
