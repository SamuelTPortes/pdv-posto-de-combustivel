package com.br.pdvpostocombustivelbackend.api.produto;

import com.br.pdvpostocombustivelbackend.api.produto.dto.ProdutoRequest;
import com.br.pdvpostocombustivelbackend.api.produto.dto.ProdutoResponse;
import com.br.pdvpostocombustivelbackend.domain.entity.Produto;
import com.br.pdvpostocombustivelbackend.domain.repository.ProdutoRepository;
...
public class ProdutoService {
    ...
    private Produto toEntity(com.br.pdvpostocombustivelbackend.api.produto.dto.ProdutoRequest req) {
        return new Produto(
                req.nome(),
                req.referencia(),
                req.fornecedor(),
